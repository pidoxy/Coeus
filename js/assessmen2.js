...
var downloadTimer = setInterval(function () {
    if (timeleft <= 0) {
        ...
        setTimeout((location.assign('./assessment_game3.html')), 4000)
    ...
    if (edit.value.length === 6 && timeleft === 0 && Number(edit.value) === 896079) {
        instruction.style.color = 'blue';
        instruction.innerHTML = 'Good!!'
    } else if (timeleft === 0 && Number(edit.value) !== 896079) {
